...
from vision_transformer_pytorch.resnet import StdConv2d
from vision_transformer_pytorch.utils import get_width_and_height_from_size, get_model_params, load_pretrained_weights
...
def get_attention_map(prev_img, img, get_mask=False):
    ...
    # mask = v[0, 1:].reshape(24, 24).detach().numpy()
    if get_mask:
